...
input int Slot0IndParam0 = 80; // Period
...
input int Slot1IndParam1 = 50; // Level
static input string IndicatorName2 = "Moving Averages Crossover"; // ------ Indicator parameters ------
input int Slot2IndParam0 = 1; // Fast MA period
input int Slot2IndParam1 = 12; // Slow MA period
...
input int Slot5IndParam0 = 200; // Take Profit


static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------

// A unique number of the expert's orders.
static input int Expert_Magic = 18124513; // Expert Magic Number
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   strategy.FirstBar               = 83;
   strategy.MinBarsRequired        = 84;
