...
static input string Ind0 = "------------";// ----- Money Flow Index -----
...
input int Ind1Param2 = 11; // Teeth period
input int Ind1Param3 = 6; // Teeth shift
input int Ind1Param4 = 6; // Lips period
input int Ind1Param5 = 5; // Lips shift

static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------
static input int Magic_Number = 98006937; // Magic Number
...
void ManageOpen()
  {
   double ind0val1 = iMFI(NULL,0,Ind0Param0,1);
   double ind0val2 = iMFI(NULL,0,Ind0Param0,2);
   double ind0val3 = iMFI(NULL,0,Ind0Param0,3);
...
void ManageClose()
  {
   double ind1val1 = iAlligator(NULL,0,Ind1Param0,Ind1Param1,Ind1Param2,Ind1Param3,Ind1Param4,Ind1Param5,MODE_SMMA,PRICE_MEDIAN,MODE_GATORLIPS,1);
   ...
   double ind1val3 = iAlligator(NULL,0,Ind1Param0,Ind1Param1,Ind1Param2,Ind1Param3,Ind1Param4,Ind1Param5,MODE_SMMA,PRICE_MEDIAN,MODE_GATORLIPS,2);
...
/*STRATEGY CODE {"openFilters":[{"listIndexes":[7,0,0,0,0],"numValues":[7,20,0,0,0,0],"name":"Money Flow Index"}],"closeFilters":[{"listIndexes":[9,3,4,0,0],"numValues":[35,17,11,6,6,5],"name":"Alligator"}],"properties":{"entryLots":0.01,"stopLoss":40,"takeProfit":90,"useStopLoss":true,"useTakeProfit":true}} */
