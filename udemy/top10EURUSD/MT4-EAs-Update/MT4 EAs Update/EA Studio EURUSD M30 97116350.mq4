...
input int Ind0Param1 = 43; // Slow MA period
static input string Ind1 = "------------";// ----- Alligator -----
input int Ind1Param0 = 35; // Jaws period
...
static input string Ind3 = "------------";// ----- Bollinger Bands -----
input int Ind3Param0 = 13; // Period
input double Ind3Param1 = 3.54; // Deviation

static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------
static input int Magic_Number = 97116350; // Magic Number
...
void ManageOpen()
  {
   double ind0val1 = iMA(NULL,0,Ind0Param0,0,MODE_SMA,PRICE_CLOSE,1);
   double ind0val2 = iMA(NULL,0,Ind0Param1,0,MODE_SMA,PRICE_CLOSE,1);
   bool ind0long  = ind0val1 < ind0val2 - sigma;
   bool ind0short = ind0val1 > ind0val2 + sigma;

   double ind1val1 = iAlligator(NULL,0,Ind1Param0,Ind1Param1,Ind1Param2,Ind1Param3,Ind1Param4,Ind1Param5,MODE_SMMA,PRICE_MEDIAN,MODE_GATORJAW,1);
   double ind1val2 = iAlligator(NULL,0,Ind1Param0,Ind1Param1,Ind1Param2,Ind1Param3,Ind1Param4,Ind1Param5,MODE_SMMA,PRICE_MEDIAN,MODE_GATORJAW,2);
   bool ind1long  = ind1val1 < ind1val2 - sigma;
   bool ind1short = ind1val1 > ind1val2 + sigma;

   double ind2val1 = iDeMarker(NULL,0,Ind2Param0,1);
   double ind2val2 = iDeMarker(NULL,0,Ind2Param0,2);
...
void ManageClose()
  {
   double ind3upBand1 = iBands(NULL,0,Ind3Param0,Ind3Param1,0,PRICE_CLOSE,MODE_UPPER,1);
   double ind3dnBand1 = iBands(NULL,0,Ind3Param0,Ind3Param1,0,PRICE_CLOSE,MODE_LOWER,1);
   double ind3upBand2 = iBands(NULL,0,Ind3Param0,Ind3Param1,0,PRICE_CLOSE,MODE_UPPER,2);
   double ind3dnBand2 = iBands(NULL,0,Ind3Param0,Ind3Param1,0,PRICE_CLOSE,MODE_LOWER,2);
...
/*STRATEGY CODE {"openFilters":[{"listIndexes":[3,0,0,0,0],"numValues":[25,43,0,0,0,0],"name":"Moving Averages Crossover"},{"listIndexes":[5,3,4,0,0],"numValues":[35,20,20,4,4,3],"name":"Alligator"},{"listIndexes":[1,0,0,0,0],"numValues":[34,0,0,0,0,0],"name":"DeMarker"}],"closeFilters":[{"listIndexes":[3,3,0,0,0],"numValues":[13,3.54,0,0,0,0],"name":"Bollinger Bands"}],"properties":{"entryLots":0.01,"stopLoss":110,"takeProfit":50,"useStopLoss":true,"useTakeProfit":true}} */
