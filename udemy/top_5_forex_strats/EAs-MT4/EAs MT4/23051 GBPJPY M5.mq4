...
input int Ind1Param0 = 100; // Period
input int Ind1Param1 = 40; // Level

static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------
static input int Magic_Number = 03657566; // Magic Number
...
/*STRATEGY CODE {"openFilters":[{"listIndexes":[1,3,0,0,0],"numValues":[30,2.5,0,0,0,0],"name":"Bollinger Bands"}],"closeFilters":[{"listIndexes":[4,3,0,0,0],"numValues":[100,40,0,0,0,0],"name":"RSI"}],"properties":{"entryLots":0.01,"stopLoss":40,"takeProfit":65,"useStopLoss":true,"useTakeProfit":true}} */
