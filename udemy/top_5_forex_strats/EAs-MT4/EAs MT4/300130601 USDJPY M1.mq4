...
input int Stop_Loss   = 750; // Stop Loss [point]
...
input int Slot4IndParam0 = 26; // Slow MA period
...
input int Slot5IndParam0 = 350; // Take Profit


static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------

// A unique number of the expert's orders.
static input int Expert_Magic = 18132028; // Expert Magic Number
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   strategy.FirstBar               = 63;
   strategy.MinBarsRequired        = 64;
