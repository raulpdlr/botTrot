...
input int Ind0Param1 = 55; // Slow MA period
static input string Ind1 = "------------";// ----- Momentum -----
input int Ind1Param0 = 18; // Period
input double Ind1Param1 = -83.7700; // Level

static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------
static input int Magic_Number = 97662203; // Magic Number
...
void ManageClose()
  {
   ...
   bool ind1short = ind1val1 > 200 - Ind1Param1 + sigma;
...
/*STRATEGY CODE {"openFilters":[{"listIndexes":[3,0,0,0,0],"numValues":[12,55,0,0,0,0],"name":"Moving Averages Crossover"}],"closeFilters":[{"listIndexes":[3,3,0,0,0],"numValues":[18,-83.77,0,0,0,0],"name":"Momentum"}],"properties":{"entryLots":0.01,"stopLoss":90,"takeProfit":80,"useStopLoss":true,"useTakeProfit":true}} */
