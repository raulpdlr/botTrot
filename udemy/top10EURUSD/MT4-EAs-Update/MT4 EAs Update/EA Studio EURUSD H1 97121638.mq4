...
input int Ind0Param0 = 12; // Fast MA period
input int Ind0Param1 = 29; // Slow MA period
static input string Ind1 = "------------";// ----- Volumes -----
input int Ind1Param0 = 0; // Level
static input string Ind2 = "------------";// ----- Alligator -----
input int Ind2Param0 = 37; // Jaws period
input int Ind2Param1 = 18; // Jaws shift
input int Ind2Param2 = 18; // Teeth period
input int Ind2Param3 = 14; // Teeth shift
input int Ind2Param4 = 14; // Lips period
input int Ind2Param5 = 5; // Lips shift

static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------
static input int Magic_Number = 97121638; // Magic Number
...
void ManageClose()
  {
   ...
   double ind2val2 = iAlligator(NULL,0,Ind2Param0,Ind2Param1,Ind2Param2,Ind2Param3,Ind2Param4,Ind2Param5,MODE_SMMA,PRICE_MEDIAN,MODE_GATORTEETH,1);
   ...
   double ind2val4 = iAlligator(NULL,0,Ind2Param0,Ind2Param1,Ind2Param2,Ind2Param3,Ind2Param4,Ind2Param5,MODE_SMMA,PRICE_MEDIAN,MODE_GATORTEETH,2);
...
/*STRATEGY CODE {"openFilters":[{"listIndexes":[3,0,0,0,0],"numValues":[12,29,0,0,0,0],"name":"Moving Averages Crossover"},{"listIndexes":[0,0,0,0,0],"numValues":[0,0,0,0,0,0],"name":"Volumes"}],"closeFilters":[{"listIndexes":[7,3,4,0,0],"numValues":[37,18,18,14,14,5],"name":"Alligator"}],"properties":{"entryLots":0.01,"stopLoss":46,"takeProfit":65,"useStopLoss":true,"useTakeProfit":true}} */
