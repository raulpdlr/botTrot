...
input int Stop_Loss   = 56; // Stop Loss (pips)
input int Take_Profit = 48; // Take Profit (pips)
static input string Ind0 = "------------";// ----- Moving Averages Crossover -----
input int Ind0Param0 = 20; // Fast MA period
input int Ind0Param1 = 34; // Slow MA period
...
static input int Magic_Number = 97112726; // Magic Number
...
/*STRATEGY CODE {"openFilters":[{"listIndexes":[3,0,0,0,0],"numValues":[20,34,0,0,0,0],"name":"Moving Averages Crossover"}],"closeFilters":[{"listIndexes":[5,0,0,0,0],"numValues":[0,0,0,0,0,0],"name":"Awesome Oscillator"}],"properties":{"entryLots":0.01,"stopLoss":56,"takeProfit":48,"useStopLoss":true,"useTakeProfit":true}} */
