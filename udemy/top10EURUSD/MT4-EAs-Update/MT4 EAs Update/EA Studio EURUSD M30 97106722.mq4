...
void ManageOpen()
  {
   ...
   double ind0val3 = iMA(NULL,0,Ind0Param0,0,MODE_SMA,PRICE_CLOSE,2);
   double ind0val4 = iMA(NULL,0,Ind0Param1,0,MODE_SMA,PRICE_CLOSE,2);
...
/*STRATEGY CODE {"openFilters":[{"listIndexes":[0,0,0,0,0],"numValues":[8,40,0,0,0,0],"name":"Moving Averages Crossover"}],"closeFilters":[{"listIndexes":[4,3,0,0,0],"numValues":[25,0.3,0,0,0,0],"name":"Envelopes"}],"properties":{"entryLots":0.01,"stopLoss":75,"takeProfit":50,"useStopLoss":true,"useTakeProfit":true}} */
