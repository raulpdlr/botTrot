...
input int Take_Profit = 107; // Take Profit (pips)
static input string Ind0 = "------------";// ----- Moving Averages Crossover -----
input int Ind0Param0 = 19; // Fast MA period
input int Ind0Param1 = 43; // Slow MA period
static input string Ind1 = "------------";// ----- Stochastic -----
input int Ind1Param0 = 15; // %K Period
input int Ind1Param1 = 9; // %D Period
input int Ind1Param2 = 5; // Slowing
input int Ind1Param3 = 6; // Level

static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------
static input int Magic_Number = 97092752; // Magic Number
...
/*STRATEGY CODE {"openFilters":[{"listIndexes":[3,0,0,0,0],"numValues":[19,43,0,0,0,0],"name":"Moving Averages Crossover"}],"closeFilters":[{"listIndexes":[3,0,0,0,0],"numValues":[15,9,5,6,0,0],"name":"Stochastic"}],"properties":{"entryLots":0.01,"stopLoss":80,"takeProfit":107,"useStopLoss":true,"useTakeProfit":true}} */
