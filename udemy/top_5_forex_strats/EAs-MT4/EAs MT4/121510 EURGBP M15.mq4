...
input int Slot0IndParam0 = 10; // Tenkan
input int Slot0IndParam2 = 30; // Kijun
input int Slot0IndParam4 = 70; // Senkou Span B
static input string IndicatorName1 = "Commodity Channel Index"; // ------ Indicator parameters ------
input int Slot1IndParam0 = 10; // Smoothing period
...
input int Slot2IndParam0 = 60; // Smoothing period
...
input int Slot3IndParam0 = 20; // Smoothing period
...
input int Slot4IndParam0 = 500; // Stop Loss
input int Slot4IndParam1 = 900; // Take Profit


static input string ExpertSettings__ = "------------"; // ------ Expert Settings ------

// A unique number of the expert's orders.
static input int Expert_Magic = 18125314; // Expert Magic Number
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   strategy.StrategyName           = "121510 EURGBP M15";
   ...
   strategy.Description            = "Exported on 11/18/2017 from Forex Strategy Builder Professional, v3.8.4";
   strategy.RecommendedBars        = 1000;
   strategy.FirstBar               = 73;
   strategy.MinBarsRequired        = 74;
