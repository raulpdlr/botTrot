...
input int Stop_Loss   = 950; // Stop Loss [point]
...
input int Slot0IndParam0 = 140; // MA period
input double Slot0IndParam1 = 3; // Multiplier
static input string IndicatorName1 = "Moving Averages Crossover"; // ------ Indicator parameters ------
input int Slot1IndParam0 = 5; // Fast MA period
input int Slot1IndParam1 = 15; // Slow MA period
...
static input int Expert_Magic = 18131019; // Expert Magic Number
...
Strategy *StrategyManager::GetStrategy(void)
  {
   ...
   strategy.StrategyName           = "10013 EURGBP M1";
   ...
   strategy.FirstBar               = 143;
   strategy.MinBarsRequired        = 144;
